...
namespace amms {
    ...
    //
    void CTableWidget::SetText(int v_iRowId, std::string v_strColumn, std::string v_strContent)
    {
        this->item(v_iRowId, this->GetColumnIndex(v_strColumn))->setText(v_strContent.c_str());
    }

    //
    void CTableWidget::SetText(int v_iRowId, std::string v_strColumn, std::string v_strContent, const QColor& v_pcColor)
    {
        this->item(v_iRowId, this->GetColumnIndex(v_strColumn))->setText(v_strContent.c_str());
